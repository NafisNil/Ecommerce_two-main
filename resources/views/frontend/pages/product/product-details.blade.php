              ...
              <div class="row">
                      ...
                      <div class="single_product_thumb">
                          <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                   ...
                                   @foreach ($photo as $key=>$item)
                                        <div class="carousel-item {{ $key == 0 ? 'active':'' }}">
                                             <a class="gallery_img" href="{{ $item }}" title="{{ $product->title }}">
                                             <img class="d-block w-100" src="{{ $item }}" alt="{{ $product->title }}">
                                             </a>
                                             <!-- Product Badge -->
                                             <div class="product_badge">
                                             <span class="badge-new">New</span>
                              ...
                              <ol class="carousel-indicators">
                                   ...
                                   @endphp
                                   @foreach ($photo as $key=>$item)
                                        <li class="{{ $key == 0 ? 'active':'' }}" data-target="#product_details_slider" data-slide-to="{{ $key }}" style="background-image: url({{ $item }});">
                                        </li>
                                   @endforeach
                              </ol>
                          </div>
                  ...
                  <div class="col-12 col-lg-6">
                      <div class="single_product_desc">
                          ...
                          <h4 class="price mb-4">${{ number_format($product->offer_price, 2) }} <del class="text-danger">${{ number_format(@$product->price, 2) }}</del></h4>
                          <!-- Overview -->
                        ...
                        {{--  <div class="widget p-0 color mb-3">
                          ...
                          <div class="others_info_area mb-3 d-flex flex-wrap">
                              <a class="add_to_wishlist" href="bigshop-2.3.0/wishlist.html"><i class="fa fa-heart" aria-hidden="true"></i> WISHLIST</a>
                              <a class="add_to_compare" href="bigshop-2.3.0/compare.html"><i class="fa fa-th" aria-hidden="true"></i> COMPARE</a>
                          ...
                          <div class="sizeguide">
                              ...
                              <div class="size_guide_thumb d-flex">
                                  <a class="size_guide_img" href="bigshop-2.3.0/bigshop-2.3.0/img/bg-img/size-1.png" style="background-image: url(bigshop-2.3.0/img/bg-img/size-1.png);">
                                  </a>
                                  <a class="size_guide_img" href="bigshop-2.3.0/bigshop-2.3.0/img/bg-img/size-2.png" style="background-image: url(bigshop-2.3.0/img/bg-img/size-2.png);">
                                  </a>
                                  <a class="size_guide_img" href="bigshop-2.3.0/bigshop-2.3.0/img/bg-img/size-3.png" style="background-image: url(bigshop-2.3.0/img/bg-img/size-3.png);">
                                  </a>
                              </div>
                          </div>
                      </div>
