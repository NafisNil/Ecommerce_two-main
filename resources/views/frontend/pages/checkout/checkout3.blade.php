...
@section('content')
    ...
    <div class="checkout_steps_area">
        ...
        <a class="complated" href="{{ route('checkout1.store') }}"><i class="icofont-check-circled"></i> Shipping</a>
        <a class="active" href="{{ route('checkout2.store') }}"><i class="icofont-check-circled"></i> Payment</a>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="checkout_pagination d-flex justify-content-end mt-30">
                        <a href="{{ route('checkout2.store') }}l" class="btn btn-primary mt-2 ml-2">Go Back</a>
