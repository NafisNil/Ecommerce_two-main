            ...
            <div class="col-12 col-md-7 col-lg-8 col-xl-3">
                ...
                <div class="single_footer_area mb-100">
                    ...
                    <div class="apps_download">
                        <a href="#"><img src="{{ asset('frontend') }}/bigshop-2.3.0/img/core-img/play-store.png" alt="Play Store"></a>
                        <a href="#"><img src="{{ asset('frontend') }}/bigshop-2.3.0/img/core-img/app-store.png" alt="Apple Store"></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="payment_method">
                        <img src="bigshop-2.3.0/img/payment-method/paypal.png" alt="">
                        <img src="bigshop-2.3.0/img/payment-method/maestro.png" alt="">
                        <img src="bigshop-2.3.0/img/payment-method/western-union.png" alt="">
                        <img src="bigshop-2.3.0/img/payment-method/discover.png" alt="">
                        <img src="bigshop-2.3.0/img/payment-method/american-express.png" alt="">
                    </div>
                </div>
            </div>
        </div>
