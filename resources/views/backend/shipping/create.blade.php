        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <form class="form-horizontal" action="{{ route('shipping.store') }}" method="POST">
                @csrf
                <br>
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea name="shipping_address" class="form-control"  id="" cols="30" rows="10">{{ old('shipping_address') }}</textarea>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="delivery_time" value="{{ old('delivery_time') }}" id="" class="form-control" >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" step="any" name="delivery_charge" value="{{ old('delivery_charge') }}" id="" class="form-control" >
