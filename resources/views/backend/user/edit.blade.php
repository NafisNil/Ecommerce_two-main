              ...
              <form class="form-horizontal" action="{{ route('user.update', $user->id) }}" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="" placeholder="full name" name="full_name" value="{{ $user->full_name }}" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="" placeholder="user name" name="username" value="{{ $user->username }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="" placeholder="full email" name="email" value="{{ $user->email }}" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="" placeholder="phone" name="phone" value="{{ $user->phone }}" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea name="address" id="description" cols="30" rows="5" class="form-control" >{{ $user->address }}</textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="" placeholder="password" name="password" value="{{ $user->password }}" required>
                    </div>
                  </div>
