              ...
              <form class="form-horizontal" action="{{ route('coupon.update', $coupon->id) }}" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="" placeholder="eg. EID" name="code" value="{{ $coupon->code }}" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="" placeholder="eg. 5% or 100TK " name="value" value="{{ $coupon->value }}" required>
                    </div>
                  </div>
